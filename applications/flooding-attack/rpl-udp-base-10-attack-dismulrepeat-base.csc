...
var attacker2 = sim.getMoteWithID(5);


var attacker3 = sim.getMoteWithID(8);
YIELD_THEN_WAIT_UNTIL(msg.equals("start_attack"));

log.log("dis-repeat-mul flooding attack from " + attacker.getID() +"and" + attacker2.getID() + attacker3.getID() + "!\n");
write(attacker, "dis-repeat-attack");
write(attacker2, "dis-repeat-attack");
write(attacker3, "dis-repeat-attack");
